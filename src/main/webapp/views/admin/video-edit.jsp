...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="/SOF3011_ASM2/index" class="brand-link"> <img
				src="<c:url value='/templates/admin/dist/img/AdminLTELogo.png'/>"
		...
		<div class="content-wrapper">
			...
			<div class="content-header" style="background: #1b2d3c; color: #ccc">
			...
			<!-- Main content -->
			<section class="content" style="background: #151d25">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary" style="background: #1b2d3c;color:#ccc">
								...
								<div class="card-body">
									<div class="form-group">
										<label for="title">Title</label> <input type="text" id="title"
											value="${video != null ? video.title : '' }" class="form-control" style="background-color: #17242e;color: #ccc">
									</div>
									<div class="form-group">
										<label for="href">Href</label> <input type="text" id="href"
											value="${video != null ? video.href : '' }" class="form-control" style="background-color: #17242e;color: #ccc">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-9">
												<div class="row">
													<div class="col-12 form-group">
														...
														<textarea id="description" style="background-color: #17242e;color: #ccc" class="form-control" rows="4">${video != null ? video.description : '' }</textarea>
													</div>
													<div class="col-12 form-group">
														<label for="poster">Poster</label> <input type="text"
															id="poster" value="${video != null ? video.poster : '' }" style="background-color: #17242e;color: #ccc" class="form-control">
	...
	<script>
		...
		$('#submitBtn').click(function() {
			...
			if(isEdit == 'true'){
				alert('true');
				url = '/SOF3011_ASM2/admin/video?action=edit&href=' + hrefOrigin;
			}else{
				alert('false');
				url = '/SOF3011_ASM2/admin/video?action=add';
			}
		 	var formData = {
		...
		$.ajax({
			...
			window.location.href = "http://localhost:8080/SOF3011_ASM2/admin/video?action=view";
		}).fail(function(error){
