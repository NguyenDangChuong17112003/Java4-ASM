...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<!-- Navbar -->
		<nav
			class="main-header navbar navbar-expand navbar-white navbar-light"  style="background: #1b2d3c;color: #ccc">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
		...
		<div class="content-wrapper">
			...
			<div class="content-header" style="background: #12171b;color: #ccc">
			...
			<section class="content" style="background: #151d25">
				<div class="card" style="background: #1b2d3c;color: #ccc">
									...
									<tr>
										...
										<td>
											<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>"
												class="btn btn-block btn-success btn-sm">Sửa</a>
											<button type="button" class="btn btn-block btn-danger btn-sm"
												onclick="deleteVideo('${item.href}')">Xóa</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
	...
	function deleteVideo(href) {
		$.ajax({
			url: '/SOF3011_ASM2/admin/video?action=delete&href=' + href
			}).then(function(data) {
