...
<title>Thái Huy Hoạt Hình</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<!-- Navbar -->
		<nav
			class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #1b2d3c">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" style="color: #ccc" data-widget="pushmenu"
					href="#" role="button"><i class="fas fa-bars"></i></a></li>
				<li class="nav-item d-none d-sm-inline-block"><a
					href="index3.html" class="nav-link" style="color: #ccc">Home</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a style="color: #ccc" href="#"
						...
						<form class="form-inline">
							<div class="input-group input-group-sm">
								<input class="form-control form-control-navbar" type="search"
									placeholder="Search" aria-label="Search" style="color: white; background: #17242e;">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="index" class="brand-link"> <img
				src="<c:url value='/templates/admin/'/>dist/img/AdminLTELogo.png"
		...
		<div class="content-wrapper">
			...
			<div class="content-header" style="background-color: #12171b">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0" style="color: #ccc">Danh sách video</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#"  style="color: #ccc">Home</a></li>
								<li class="breadcrumb-item active"  style="color: #ccc">Danh sách video</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<!-- Main content -->
			<section class="content" style="background-color: #151d25">
				<div class="card" style="background-color: #1b2d3c;color: #ccc !important;" >
					<div class="card-header">
						<h3 class="card-title">Thống kê lượt yêu thích</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
		...
		<!-- /.content-wrapper -->
		<footer class="main-footer" style="background-color: #101720">
